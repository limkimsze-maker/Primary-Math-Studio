...
assert.deepEqual(plain(moneyActionPhases(add.actions[1])),[['move',2000],['group',2300],['exchange',2000],['record',1200]],'A regrouping step must pause at every visible stage.');
...
assert.deepEqual(plain(moneyActionPhases(subtract.actions[1])),[['donor',2000],['exchange',2400],['record',1300]],'Borrowing must pause on the donor, exchange and written rename.');
